...
tree -a -I '.git|node\_modules|\_\_pycache\_\_|.venv|venv|.env|\*.pyc|.DS\_Store' --dirsfirst
...
find . -name "main.py" -o -name "app.py" -o -name "index.py" -o -name "\_\_main\_\_.py"
...
find . -path "\*/test\*" -name "\*.py" -o -name "\*\_test.py" -o -name "test\_\*.py"
...
1\. \*\*CODE\_REVIEW.md\*\* - Full review report (in project root or docs/)

2\. \*\*REVIEW\_SUMMARY.md\*\* - Executive summary for quick reference

3\. \*\*REMEDIATION\_TASKS.md\*\* - Actionable task list (can import to issue tracker)



\### REMEDIATION\_TASKS.md Format
...
tree -a -I '.git|node\_modules|\_\_pycache\_\_|.venv|venv|.env' --dirsfirst
...
\- CODE\_REVIEW.md (detailed)

\- REVIEW\_SUMMARY.md (executive)

\- REMEDIATION\_TASKS.md (actionable)
